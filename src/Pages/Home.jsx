...
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/ToZall", label: "GitHub Profile" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/tozall/", label: "LinkedIn Profile" },
  { icon: Instagram, link: "https://www.instagram.com/tozall_/?hl=id", label: "Instagram Profile" }
];
        ...
        <script type="application/ld+json">{`
          {
            ...
            "sameAs": [
              ...
              "https://www.instagram.com/tozall_/"
            ]
          }
        `}</script>
      </Helmet>
